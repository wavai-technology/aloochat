...
describe('#getUserString', () => {
  it('returns correct user string', () => {
    expect(
      getUserString({
        user: {
          ...
          avatar_url: 'https://images.aloochat.ai/placeholder',
          identifier_hash: '12345',
        },
        identifier: '12345',
      })
    ).toBe(
      'avatar_urlhttps://images.aloochat.ai/placeholderemailpranav@example.comnamePranavidentifier_hash12345identifier12345'
    );
    ...
    expect(
      ...
      'avatar_urlhttps://images.aloochat.ai/placeholderemailpranav@example.comnameidentifier_hashidentifier'
    );
  });
});
