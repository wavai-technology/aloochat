...
const conversationWithoutMeta = {
  ...
  lastNonActivityMessage: {
    ...
    conversation: {
      ...
      contact_inbox: {
        source_id: 'candice@alloochat.ai',
      },
    },
    sender: {
      id: 1,
