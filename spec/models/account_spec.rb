...
RSpec.describe Account do
  ...
  describe 'support_email' do
    ...
    it 'returns the support email from inbox if inbox value is present' do
      account.update(support_email: 'support@alloochat.ai')
      with_modified_env MAILER_SENDER_EMAIL: 'hello@alloochat.ai' do
        expect(account.support_email).to eq('support@alloochat.ai')
      end
    end
    ...
    it 'returns the support email from ENV if inbox value is nil' do
      ...
      with_modified_env MAILER_SENDER_EMAIL: 'hello@alloochat.ai' do
        expect(account.support_email).to eq('hello@alloochat.ai')
      end
    end
